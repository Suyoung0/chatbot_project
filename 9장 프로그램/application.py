...
def chat_api(): 
    request_message = request.form.get('message', '')      # ✅ FormData 방식으로 받기
    # image_file = request.files.get('image')      
    #print("✅ Received image:", image_file.filename if image_file else "None")
    # print("✅ Received message:", request_message)
